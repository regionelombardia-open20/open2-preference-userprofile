    ...
    <div class="container">
        <div class="row variable-gutters">
            ...
            <div class="col-12 col-md-8 px-3">
                <h1 class="h2">Email già validata</h1>
                ...
                La tua email di accesso è già stata validata, il link cliccato è già stato utilizzato per validare l'email.
                </p>
                <div class="d-flex justify-content-md-end justify-content-center mt-5">
                    <a href="/it/" class="btn btn-primary mb-2 float-right" title="accedi all'area riservata">Accedi</a>
                </div>
            </div>
        </div>
    </div>
