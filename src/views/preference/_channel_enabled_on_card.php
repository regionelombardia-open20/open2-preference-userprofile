...
<div>
    ...
    <div class="d-flex">
        <?php
        if ($channelEmail) {
            echo '<div class="btn-icon d-block mr-3"><span class="rounded-icon border border-secondary rounded-circle mx-auto p-1"><svg class="icon icon-secondary" role="img">
